...
public class InternalRequestFactory {
    private InternalRequestFactory() {}

    public static CrackHashManagerRequest constructRequest(
            CrackRequest crackRequest, Integer partCount,
            Integer partNumber, UUID uuid)
    {
