...
import ru.nsu.fit.kn.repository.CustomHashRepositoryInterface;
...
public class ManagerService {
    ...
    @Autowired
    private CustomHashRepositoryInterface customHashRepository;
    ...
    public CrackResponse callCrackService(CrackRequest crackRequest) {
        ...
        for(int i = 0; i < Integer.parseInt(workersAmount); i++) {
            ...
            CrackHashManagerRequest request = InternalRequestFactory
                    .constructRequest(crackRequest, i, Integer.parseInt(workersAmount), uuid);
